                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredCustomers.map((customer) => (
                            <div key={customer._id} className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
                                    ...
                                    {customer.role === 'vendor' && customer.vendorDetails && (
                                        <div className="pt-3 border-t border-gray-100 mt-3">
                                            ...
                                            <div className="space-y-1 text-sm text-gray-600 mb-3">
                                                <p><span className="font-medium">Business:</span> {customer.vendorDetails.businessName}</p>
